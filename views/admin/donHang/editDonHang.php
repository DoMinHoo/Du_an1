        ...
        <div class="row">
            <div class="col-12" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user_id" value="<?php echo $edit['user_id']?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="total_amount" value="<?php echo $edit['total_amount']?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="shipping_address">Shipping Adrress</label>
                    <input type="text" class="form-control" name="shipping_address" value="<?php echo $edit['shipping_address']?>" >
                </div>
                <div class="form-group">
                    <label for="create_at">Create At</label>
                    <input type="text" class="form-control" name="create_at" value="<?php echo $edit['create_at']?>" readonly>
                </div>
                <div class="form-group">
